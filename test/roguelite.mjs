...
// ---------- HP スケール ----------
eq(allyScaledHp(25000), 1000 * HP_SCALE, "25000点→20000HP（HP桁上げ後）");
eq(floorEnemyHp(1), 700 * HP_SCALE, "階層1の敵HP=14000（旧700×桁上げ）");
...
eq(run.party[0].hp, 1000 * HP_SCALE, "あなたHP=20000");
...
eq(run.party[0].hp, 650 * HP_SCALE, "25%回復=+5000");
