...
function mentorGreeting(mentor) {
  const byId = {
    ...
    kakeha_ruina: "へえ——いい目をしてる。あたしと組むなら、生き方ごと張ってもらうよ。",
    kuidoshi: "……ようこそ。ド派手な手は、僕には通用しないよ。——まずは、沈まないことから、覚えようか。",
    // ドラニエル＝逆スカウト（ep1「組もうぞ！」）。弟子が選んだ体でも“向こうが先に決めていた”固有性。
    doranie: "ふぉっふぉ、来たな！　実はの、わらわはとっくに決めておったぞ——ぬしを弟子にするとな！　組もうぞ！",
    // ルクス・ゼロ＝入門は“検証”として始まる（ep1「検証を開始する」＝枠物語の起点）。
    yobinin: "……弟子入りを、許可する。ただし、これは検証だ。私は師匠ではなく、貴殿は被験者——誤差は、消す。ついて来られるか。",
  };
