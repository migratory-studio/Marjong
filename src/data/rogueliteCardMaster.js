...
export const ROGUELITE_CARD_MASTER = [
  ...
  // ---- 宝珠解禁キャラ由来の必殺技（札）：本人の能力を味方に宿す。敵（強敵/ボス）も使う ----
  {
    id: "grant-bibi",
    name: "身代わり人形（札）",
    desc: "着卓する味方に「身代わり人形」が宿る。6打牌のあいだロン/ツモを帳消し（失点0・勝者も得点0）＝【守備】の切り札。",
    rarity: "legendary",
    effect: { kind: "grantAbility", abilityId: "bibi" },
    cluster: "guard",
    stackable: false,
  },
  {
    id: "grant-amber-shield",
    name: "琥珀の盾（札）",
    desc: "着卓する味方に「琥珀の盾」が宿る。満貫以上の放銃・被ツモを盾で受け止める持続シールド＝【守備】の到達点。",
    rarity: "legendary",
    effect: { kind: "grantAbility", abilityId: "amber-shield" },
    cluster: "guard",
    stackable: false,
  },
  {
    id: "grant-zero-search",
    name: "ゼロ・リサーチ（札）",
    desc: "着卓する味方に「ゼロ・リサーチ」が宿る。1シャンテンから有効牌を確定ツモして聴牌を決める＝【速攻】の核。",
    rarity: "legendary",
    effect: { kind: "grantAbility", abilityId: "zero-search" },
    cluster: "tempo",
    stackable: false,
  },
  {
  ...
  },
  {
    id: "grant-kakeha-bet",
    name: "大博打（札）",
    desc: "着卓する味方に「大博打」が宿る。5000点で1.5倍／10000点で2倍に賭ける一か八か＝【博打】の柱。",
    rarity: "epic",
    effect: { kind: "grantAbility", abilityId: "kakeha-bet" },
    cluster: "gamble",
    stackable: false,
  },
  {
    id: "grant-recall-deal",
    name: "リコール・ディール（札）",
    desc: "着卓する味方に「リコール・ディール」が宿る。ツモ牌を河へ置き、捨てた牌を1枚回収して手を組み直す＝【速攻】の手繰り。",
    rarity: "epic",
    effect: { kind: "grantAbility", abilityId: "recall-deal" },
    cluster: "tempo",
    stackable: false,
  },
