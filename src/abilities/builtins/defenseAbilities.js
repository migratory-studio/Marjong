...
export class DangerSenseAbility extends Ability {
  ...
  [Hooks.PROVIDE_DANGER_INFO](ctx, api) {
    ...
    const opps = api.opponents();
    const threats = opps.filter((p) => p.riichi || p.melds.length > 0);
