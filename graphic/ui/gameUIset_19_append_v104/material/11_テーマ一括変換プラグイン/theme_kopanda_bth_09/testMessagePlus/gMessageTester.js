...
window.gMessageTester = {
	...
	,cssUrl: "./data/others/plugin/theme_kopanda_bth_09/testMessagePlus/style.css"
	,sampleUrl: "./data/others/plugin/theme_kopanda_bth_09/testMessagePlus/sampletext.ks"
